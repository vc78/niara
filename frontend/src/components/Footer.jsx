  ...
  return (
    <footer className="footer" style={{
      ...
      <div className="footer-content" style={{
        ...
        <div className="footer-brand">
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
            <img src="/logo.png" alt="Label by Sahithi Nandhan" style={{ height: '40px', objectFit: 'contain' }} />
            <h3 style={{ 
          ...
          <div className="social-links" style={{ display: 'flex', gap: '15px' }}>
            <a href="https://www.instagram.com/label_by_sahithi_nandan/" target="_blank" rel="noopener noreferrer" style={{
      ...
      <div className="footer-bottom" style={{
        ...
        <p>© {currentYear} Label by Sahithi Nandhan. Crafted with ♥ in Hyderabad</p>
      </div>
    </footer>
  );
};
